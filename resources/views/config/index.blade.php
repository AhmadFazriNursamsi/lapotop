...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight hetf2"><i class="fa fa-wrench"></i>
            {{ __('Config') }} <?php if($haveaccessadd): ?> <button type="button" id="btnAdd" class="btn btn-sm btn-success m-2" data-togle="modal" data-target="#addModal"><i class="fa fa-plus me-2"></i>Add Config</button> <?php endif; ?>
        </h2>
    </x-slot>
...
<div class="modal fade" id="view" tabindex="-1" role="dialog" aria-labelledby="viewTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-md" role="document">
    ...
    <div class="modal-footer">
      ...
      @if ($haveaccessadd) :
        <span id="editvbtn" data-attid="" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Edit Config</span>
      @endif
...
@if ($haveaccessadd) :
<!-- add modal -->
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="viewTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
...
<script type="text/javascript">
    ...
    $("#editvbtn").click(function(){
        ...
        clearInput("inpt-cst-add");
        $("#ModalLongTitle").html("Edit Config");
    ...
    function showdetail(idx){
      $('#deletevbtn').html('<i class="fa fa-trash"></i> Delete Config');
      $('#undeletevbtn').html('<i class="fa fa-repeat"></i> Undelete Config');
